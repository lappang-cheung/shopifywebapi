...
const RootQuery = new GraphQLObjectType({
    ...
    fields: {
        ...
        // Display all products from many different stores
        products: {
            type: new GraphQLList(ProductType),
            resolve(parentValue, args){
        ...
        // Display all orders from different stores
        orders: {
            type: new GraphQLList(OrderType),
            resolve(parentValue, args){
        ...
        // Display all line items for orders and products
        lineItems: {
            type: new GraphQLList(LineItemType),
            resolve(parentValue, args){
                return axios.get(`http://localhost:3000/lineItems`)
                    .then(response => response.data)
            }
        } 
    }
